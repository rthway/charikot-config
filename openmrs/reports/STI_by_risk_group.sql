...
create table Spouse_of_Migrants as select person_id from valid_coded_obs_view where concept_full_name = 'STI-Risk group' and value_concept_full_name = 'Spouse of migrant' and obs_datetime between @start_date and @end_date group by person_id;
...
select 'Female Sex workers (FSWs)' as 'Risk Group / Key Population Group',
       ...
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Urethral discharge syndrome',1,0)),0) as 'Urethral Discharge',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Scortal swelling syndrome',1,0)),0) as 'Scortal Swelling',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Vaginal discharge syndrome',1,0)),0) as 'Vaginal Discharge',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Lower Abdominal pain Syndrome',1,0)),0) as 'Lower Abdominal pain',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Genital ulcer disease syndrome',1,0)),0) as 'Genital Ulcer Disease',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Inguinal bubo syndrome',1,0)),0) as 'Inguinal Bubo',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Others',1,0)),0) as 'Other',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Cervisitis',1,0)),0) as 'Cervisitis',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Vaginitis',1,0)),0) as 'Vaginitis',
       ifnull(sum(if(concept_full_name='STI-STI syndromic diagnosis' and value_concept_full_name = 'Herpes genitalis',1,0)),0) as 'Herpes genitalis',
...
from (
       select o.person_id,o.concept_full_name,o.value_concept_full_name from valid_coded_obs_view o
         ...
         ((o.concept_full_name = 'STI, Type of Case' and o.value_concept_full_name is not null) or
          ...
          (o.concept_full_name = 'STI-STI syndromic diagnosis' and o.value_concept_full_name in ('Urethral discharge syndrome','Scortal swelling syndrome','Vaginal discharge syndrome','Lower Abdominal pain Syndrome','Genital ulcer disease syndrome','Inguinal bubo syndrome','Cervisitis','Vaginitis','Herpes genitalis','Others'))) and
