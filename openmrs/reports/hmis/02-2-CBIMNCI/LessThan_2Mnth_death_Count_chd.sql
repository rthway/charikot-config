...
SELECT 
    IFNULL(SUM(CASE WHEN age_days < 29 THEN 1 ELSE 0 END),0) AS chd_less_than_29_days_count,
    IFNULL(SUM(CASE WHEN age_days > 28 AND age_days < 60 THEN 1 ELSE 0 END),0) AS chd_29_to_59_days_count
    FROM
