...
select '<=14yrs - Tested' as Indicator,
       ...
       ifnull(sum(if(gender='M' and person_id in (select person_id from valid_coded_obs_view where concept_full_name = 'HTC-Risk group' and value_concept_full_name = 'Spouse of migrant'),1,0)),0) as 'Spouse/Partners of Migrants - Male',
       ifnull(sum(if(gender='F' and person_id in (select person_id from valid_coded_obs_view where concept_full_name = 'HTC-Risk group' and value_concept_full_name = 'Spouse of migrant'),1,0)),0) as 'Spouse/Partners of Migrants - Female',
       ifnull(sum(if(gender not in ('M','F') and person_id in (select person_id from valid_coded_obs_view where concept_full_name = 'HTC-Risk group' and value_concept_full_name = 'Spouse of migrant'),1,0)),0) as 'Spouse/Partners of Migrants - TG',
